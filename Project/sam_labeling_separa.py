...
path_to_save_masks = '/home/scasao/SEPARA/unizar_DL4HSI/separa/data/Masks_raw/'
...
# Load path images
image_names, annotations_image_to_label = loader_separa_data(path_to_save_masks, clean_files_annotated=True, only_labeled=False)
