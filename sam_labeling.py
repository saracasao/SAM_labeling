...
# CHANGE PATH HERE
path_images = '/home/scasao/Documents/TEST_DATASET/SEPARA/WD_BLACK/2022-05-10/DALSA'
...
image_names = [f for f in sorted(os.listdir(path_images)) if ('.jpg' in f or '.png' in f)]
# image_names = ['rgb_20220928_11-25-14.npy']
